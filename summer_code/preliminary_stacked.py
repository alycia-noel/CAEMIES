...
windows_elf_train_dataset = windows_benign_train_set + windows_mal_train_set + elf_benign_train_set + elf_mal_train_set
windows_elf_val_dataset = windows_benign_val_set + windows_mal_val_set + elf_benign_val_set + elf_mal_val_set
windows_elf_test_dataset = windows_mal_test_set + windows_benign_test_set + elf_mal_test_set + elf_benign_test_set
...
# Save results
stacked_model_path = r'D:\saved_models\pretrained_stacked.pt'
stacked_model.save_model(stacked_model_path)

#============================================================================================================

# RESULTS
accuracies_path = r'D:\results\stackedaccuracies.png'
losses_path =r'D:\results\stackedlosses.png'

# Stacked Accuracies over N epochs
plt.figure(1)
plt.title('Stacked Network Accuracies (PE and ELF)')
...
plt.figure(2)
plt.title('Stacked Network Losses (PE and ELF)')
